...
% además de realizar las 20 iteraciones, guarda un archivo de Excel con los distintos parámetros MSE's y R's.
% Este código construye todas las configuraciones de las redes mandando llamar a la función RedValid.m, la cual es parte del Neural Network Toolbox de MATLAB. La versión utilizada de RedValid.m para este trabajo es una pequeña modificación realizada para ajustarla a nuestro trabajo.
